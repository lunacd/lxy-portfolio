        ...
        <Scroller bgColor="bg-[#FDF9F1]">
          ...
          <div className="single my-spacing-lg grid gap-spacing lg:grid-cols-2">
            ...
            <div className="lg:self-end">
              Hello! This is Shirley Lyu. I am a product designer with an
              infinite range of ideas. I am interested in lifestyle products,
              spatial experience, sustainability, social innovation, soft goods,
                ...
                <div className="flex h-full flex-col pt-16 lg:flex-row lg:pt-0">
                  ...
                  <div className="mb-4 flex w-full flex-col justify-center p-4 lg:w-1/3">
                    ...
                    <div className="paragraph">
                      ...
                      community. Kids at different ages work together as groups
                      to design clothes and have a fashion design show.
                    </div>
                  </div>
                </div>
              </div>
