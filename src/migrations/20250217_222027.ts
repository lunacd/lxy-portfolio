...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_project_pages_blocks_large_gallery_bottom_margin" AS ENUM('none', 'small', 'medium', 'regular', 'large', 'xl', 'xxl');
  ...
  CREATE TYPE "public"."enum_blogs_blocks_large_gallery_bottom_margin" AS ENUM('none', 'small', 'medium', 'regular', 'large', 'xl', 'xxl');
  ...
  CREATE TABLE IF NOT EXISTS "project_pages_blocks_large_gallery_rows" (
  	...
  	"alignment" "enum_project_pages_blocks_large_gallery_rows_alignment" DEFAULT 'start' NOT NULL
  );
  ...
  CREATE TABLE IF NOT EXISTS "project_pages_blocks_large_gallery" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"bottom_margin" "enum_project_pages_blocks_large_gallery_bottom_margin" DEFAULT 'xxl' NOT NULL,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "blogs_blocks_large_gallery_rows" (
  	...
  	"alignment" "enum_blogs_blocks_large_gallery_rows_alignment" DEFAULT 'start' NOT NULL
  );
  ...
  CREATE TABLE IF NOT EXISTS "blogs_blocks_large_gallery" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"bottom_margin" "enum_blogs_blocks_large_gallery_bottom_margin" DEFAULT 'xxl' NOT NULL,
  	"block_name" varchar
  );
