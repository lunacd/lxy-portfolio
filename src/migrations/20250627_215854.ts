...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_project_pages_blocks_emphasis_text_bottom_margin" AS ENUM('none', 'small', 'medium', 'regular', 'large', 'xl', 'xxl');
  CREATE TYPE "public"."enum_project_pages_blocks_emphasis_text_text_color" AS ENUM('dark', 'light');
  CREATE TYPE "public"."enum_blogs_blocks_emphasis_text_bottom_margin" AS ENUM('none', 'small', 'medium', 'regular', 'large', 'xl', 'xxl');
  CREATE TYPE "public"."enum_blogs_blocks_emphasis_text_text_color" AS ENUM('dark', 'light');
  CREATE TABLE "project_pages_blocks_emphasis_text" (
  	...
  	"bottom_margin" "enum_project_pages_blocks_emphasis_text_bottom_margin" DEFAULT 'xxl' NOT NULL,
  	"text_color" "enum_project_pages_blocks_emphasis_text_text_color" DEFAULT 'dark' NOT NULL,
  	"block_name" varchar
  );
  
  CREATE TABLE "blogs_blocks_emphasis_text" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	...
  	"use_background" boolean DEFAULT false NOT NULL,
  	"background_color" varchar,
  	"bottom_margin" "enum_blogs_blocks_emphasis_text_bottom_margin" DEFAULT 'xxl' NOT NULL,
  	"text_color" "enum_blogs_blocks_emphasis_text_text_color" DEFAULT 'dark' NOT NULL,
  	"block_name" varchar
  );
  
  DROP TABLE "project_pages_blocks_note" CASCADE;
  DROP TABLE "blogs_blocks_note" CASCADE;
  ALTER TABLE "project_pages_blocks_emphasis_text" ADD CONSTRAINT "project_pages_blocks_emphasis_text_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."project_pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "project_pages_blocks_emphasis_text_order_idx" ON "project_pages_blocks_emphasis_text" USING btree ("_order");
  CREATE INDEX "project_pages_blocks_emphasis_text_parent_id_idx" ON "project_pages_blocks_emphasis_text" USING btree ("_parent_id");
  CREATE INDEX "project_pages_blocks_emphasis_text_path_idx" ON "project_pages_blocks_emphasis_text" USING btree ("_path");
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "project_pages_blocks_emphasis_text" CASCADE;
  DROP TABLE "blogs_blocks_emphasis_text" CASCADE;
  ...
  DROP TYPE "public"."enum_project_pages_blocks_emphasis_text_bottom_margin";
  DROP TYPE "public"."enum_project_pages_blocks_emphasis_text_text_color";
  DROP TYPE "public"."enum_blogs_blocks_emphasis_text_bottom_margin";
  DROP TYPE "public"."enum_blogs_blocks_emphasis_text_text_color";`)
}
